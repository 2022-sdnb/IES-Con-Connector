...
class MsgReceiver {
    ...
    private boolean receiveRequest(InputStream is, short cmdId, byte[] buf) {
        ...
        requestTx.add(new Request(tk, clientId, gatewayId, cmdId, new RequestGo(time, type, data)));
    ...
    private boolean receiveResponse(InputStream is, short cmdId, byte[] buf) {
        ...
        responseTx.add(new Response(tk, cmdId, new ResponseGo(time, status, data)));
